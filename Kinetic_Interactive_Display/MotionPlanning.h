...
int current_step[NUM_COLUMNS][NUM_ROWS] = {0};    //sequence in step pattern value (0-3) and (4) sleep
int next_position[NUM_COLUMNS][NUM_ROWS];    
unsigned int step_delay[NUM_COLUMNS][NUM_ROWS];
unsigned long last_step_time[NUM_COLUMNS][NUM_ROWS] = {0};
unsigned long current_time_micros[NUM_COLUMNS][NUM_ROWS] = {0};
